<?php
	...
	$consulta = "SELECT * FROM exemplares WHERE emprestado_exemplar = 0 "; // selecionar todos os livros
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
	...
	<div class="page-header">
        <h1>Selecionar livro para empréstimo</h1>
		</div>
	<div class="container theme-showcase" role="main">
	<div id="general">
            ...
            <tbody>
			    ...
			    while($linhas = $con-> fetch_array()){ 
					echo "<tr>";
						...
						echo "</td>";
						?><td>
						<a href='btn_emprestar_livro.php?id=<?php echo $linhas['cod_exemplar']; ?>'><button type='button' class='btn btn-sm btn-warning'>Selecionar</button></a>
